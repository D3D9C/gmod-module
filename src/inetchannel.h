...
public:
	...
	void SendFile(const char* filename, unsigned int transferID) noexcept {
...
public:
	...
	virtual const char* GetName(void) const { return "swagcock$"; }
	virtual const char* ToString(void) const { return "swagcock$"; }
